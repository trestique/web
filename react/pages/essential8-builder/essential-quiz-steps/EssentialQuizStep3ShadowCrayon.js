...
class EssentialQuizStep3ShadowCrayon extends React.Component{
    constructor(props){
        super(props);
    }
    state = {
    ...
    updateCrayonShade = (item) =>{
        this.setState({shadowCrayonShade:item});
    }
    moveToBackStep = (step) =>{
    ...
    render(){
        ...
        const {shadowProductsDetails,shadow_shimmer_title,shadow_shimmer_text} = settings;
        ...
        return(
            <div className="essential-quiz-step-3 essential-shade-quiz-main essential-quiz-step-3-crayon-wrapper">
            ...
            <div className="essential-quiz-step-3-shadow-block">
                {
                    shadow_shimmer_title ? 
                    <div className="title-wrap">
                        {shadow_shimmer_title ? <h2 className="screen-2-title">{shadow_shimmer_title}</h2> : null}
                        {shadow_shimmer_text ? <span className="screen-2-subtitle">{shadow_shimmer_text}</span> : null}
                    </div> : null
                }
...
export default connect(mapStateToProps,mapDispatchToProps)(EssentialQuizStep3ShadowCrayon);