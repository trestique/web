...
class QuizStep6Lips extends React.Component{
    constructor(props){
        super(props);
    }
    state = {
    ...
    updateCrayonShade = (item) =>{
        let selectedItems  = [...this.state.lips];
        ...
        this.setState({lips:selectedItems});
    }
    goToBack = () =>{
...
export default connect(mapStateToProps,mapDispatchToProps)(QuizStep6Lips);